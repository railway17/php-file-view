	...
	function loadURL(url, container) {
		...
		$.ajax({
			...
			beforeSend : function() {
				...
				// place cog
				container.html('<h1 class="ajax-loading-animation"><i class="fal fa-cog fa-spin"></i> Loading...</h1>');
			...
			error : function(xhr, status, thrownError, error) {
				container.html('<h4 class="ajax-loading-error"><i class="fal fa-warning txt-color-orangeDark"></i> Error requesting <span class="txt-color-red">' + url + '</span>: ' + xhr.status + ' <span style="text-transform: capitalize;">'  + thrownError + '</span></h4>');
			},
			async : true 
		});
