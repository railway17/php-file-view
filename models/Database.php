...
class Database
{
    ...
    /**
     * Enable / disable global debug code
     * @var bool
     */
     ...
     */
    private function queryUnprepared($sql)
    {
        // Execute query
     ...
     */
    public function rawQuery($sql, $bindParams = null)
    {
    ...
    public function rawReturnID($sql, $bindParams = null, $returnID = false)
    {
        $params = array(''); // Create the empty 0 index
     ...
     */
    public function rawQueryOne($sql, $bindParams = null)
    {
        $res = $this->rawQuery($sql, $bindParams);
     ...
     */
    public function rawQueryValue($sql, $bindParams = null)
    {
        $res = $this->rawQuery($sql, $bindParams);
        if (!$res) {
            return null;
        ...
        $limit = preg_match('/limit\s+1;?$/i', $sql);
        $key = key($res[0]);
     ...
     *
     * @param string $sql   Contains a user-provided select query.
